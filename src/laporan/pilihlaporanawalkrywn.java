...
import Fitur.BarangMasukKaryawan;
import Fitur.Dasboard;
import Fitur.Profil_1;
import Fitur.cashier_1;
import Fitur.formBarang1;
import Fitur.formLogin1;
import Fitur.suppliek;
 ...
 * @author acer
 */
public class pilihlaporanawalkrywn extends javax.swing.JFrame {

    /**
     * Creates new form pilihlaporanawalkrywn
     */
    public pilihlaporanawalkrywn(String id_user) {
        initComponents();
        setNama(id_user);
        tampil_tanggal();
        tampil_waktu();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 330, 350, 170));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 330, 350, 180));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 440, 200, 50));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 710, 140, 50));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 200, 50));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/krywn/Laporan Karyawan Awal REVISI.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pilihlaporanawalkrywn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
