 ...
 * @author Lenovo
 */
public class laporankrywnpembelian extends javax.swing.JFrame {

    /**
     * Creates new form laporankrywnpembelian
     */
    public laporankrywnpembelian(String id_user) {
        initComponents();
        setNama(id_user);
        tampil_tanggal();
        tampil_waktu();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 280, 670, 110));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 420, 670, 110));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/krywn/Laporan pembelian Karyawan REVISI.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(laporankrywnpembelian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
