...
//        model.addColumn("Barcode");
    ...
    private void initComponents() {
        ...
        txt_tagihan.setToolTipText("");
        txt_tagihan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_tagihanActionPerformed(evt);
            }
        });
        getContentPane().add(txt_tagihan, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 160, 360, 140));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 710, 140, 50));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 190, 50));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 320, 190, 50));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, 190, 40));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 450, 190, 40));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 510, 190, 50));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 570, 190, 50));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 190, 50));

        BackgroundCs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/Kasir Admin REVISI.png"))); // NOI18N
        BackgroundCs.setToolTipText("");
        BackgroundCs.setVerticalAlignment(javax.swing.SwingConstants.TOP);
 ...
 static int totalHargaVar = 0;
    ...
    private void btn_hitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hitungActionPerformed
        if(txt_Bayar.getText().equals("") ||txt_Bayar.getText().isEmpty() ||txt_Bayar.getText().equals(null)) {
            JOptionPane.showMessageDialog(null, "Inputan Bayar Kosong");
