 ...
 * @author Lenovo
 */
public class BarangMasukKaryawan extends javax.swing.JFrame {
    ...
    public BarangMasukKaryawan(String id_user) {
        initComponents();
        load_table();
        otonamaBarang();
//        otonamaSupp();
...
//            CBNamaSupplier.getText(),
//            txtJumlah.getText(),
//            txtHargaMasuk.getText(),
...
//        try {
//            int no = 1;
//            String sql = "SELECT pembelian.id_pembelian, roti.id_roti, roti.nama, supplier.nama_supp, detail_pembelian.jumlah, "
//                            + " detail_pembelian.harga_masuk, pembelian.harga_total,  roti.stok" +
//                            " FROM roti" +
//                            " JOIN supplier ON roti.id_supp = supplier.id_supp" +
//                            " JOIN detail_pembelian ON roti.id_roti = detail_pembelian.id_roti" +
...
//    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtIdPembelian, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 194, 145, 30));
        ...
        getContentPane().add(txtIdBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 234, 145, 30));
        ...
        getContentPane().add(txtIdSupp, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 274, 145, 30));
        ...
        getContentPane().add(txtHargaTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 360, 180, 70));
        ...
        getContentPane().add(txtStok, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 310, 150, 30));
        ...
        getContentPane().add(txtHargaMasuk, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 270, 150, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 440, 120, 40));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 440, 100, 40));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 440, 110, 40));
        ...
        getContentPane().add(CBNamaBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 190, 150, 30));
        ...
        getContentPane().add(txtJumlah, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 314, 145, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 490, 750, 260));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 210, 50));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 710, 200, 50));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 210, 50));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 210, 50));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 210, 50));
        ...
        getContentPane().add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 210, 50));
        ...
        jButton11.setBackground(new java.awt.Color(245, 150, 92));
        jButton11.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton11.setForeground(new java.awt.Color(255, 255, 255));
        jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ikon/brush.png"))); // NOI18N
        ...
        getContentPane().add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 440, 100, 40));
        ...
        getContentPane().add(CBNamaSupplier, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 230, 150, 30));

        p.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/Barang masuk Karyawan REVISI.png"))); // NOI18N
        getContentPane().add(p, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1080, 770));

        jButton12.setBackground(new java.awt.Color(245, 150, 92));
        jButton12.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton12.setForeground(new java.awt.Color(255, 255, 255));
        jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ikon/bag.png"))); // NOI18N
        ...
        getContentPane().add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 360, -1, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int pop = JOptionPane.showConfirmDialog(this, "Yakin Dihapus?", "Hapus", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
...
//        load_table();
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        this.setVisible(false);
        new formBarang1(txt_username.getText()).setVisible(true); // TODO add your handling code here:
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        this.setVisible(false);
        new suppliek(txt_username.getText()).setVisible(true); // TODO add your handling code here:
...
//        load_data();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BarangMasukKaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
